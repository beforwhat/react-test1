...
//           <NavLink to={`classify/${this.state.name}`}className="background">
//             classify
//           </NavLink>
//           <NavLink to="navigation" className="background">
//             navigation
...
//           }}
//         >采用字符串形式传入路径 这里使用动态参数形式 模板字符串
//           <NavLink to={`classify?xd=${this.state.name}&website=${this.state.website}`}className="background"> ?xd=形式符合url的要求
//             classify
//           </NavLink>
//           <NavLink to="navigation" className="background">
//             navigation
...
//           }}
//         >采用字符串形式传入路径 这里使用动态参数形式 模板字符串
//           <NavLink to={`classify`} state= {{xd:this.state.name, website:this.state.website}}className="background"> ?xd=形式符合url的要求
//             classify
//           </NavLink>
//           <NavLink to="navigation" className="background">
//             navigation
